...
public class Framebuffer implements Closeable {
  ...
  public Framebuffer(SampleRender render, int width, int height) {
    try {
      ...
      GLES31.glBindTexture(GLES31.GL_TEXTURE_2D, depthTexture.getTextureId());
  ...
  public void resize(int width, int height) {
    ...
    // Color texture
    GLES31.glBindTexture(GLES31.GL_TEXTURE_2D, colorTexture.getTextureId());
