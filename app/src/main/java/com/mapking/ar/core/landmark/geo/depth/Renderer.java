/*
 * Copyright 2021 Mapking International
 *
...
package com.mapking.ar.core.landmark.geo.depth;
...
final class Renderer {
  ...
  public void createOnGlThread(Context context) throws IOException {
    ...
    GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER, positionBufferSize, null, GLES31.GL_DYNAMIC_DRAW);

    GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER, colorBuffer);
    colorBufferSize = INITIAL_BUFFER_POINTS * COLOR_BYTES_PER_POINT;
    GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER, colorBufferSize, null, GLES31.GL_DYNAMIC_DRAW);
    ...
    int passthroughShader =
        ShaderUtil.loadGLShader(TAG, context, GLES31.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);

    programName = GLES31.glCreateProgram();
    GLES31.glAttachShader(programName, vertexShader);
    GLES31.glAttachShader(programName, passthroughShader);
    GLES31.glLinkProgram(programName);
    GLES31.glUseProgram(programName);

    ShaderUtil.checkGLError(TAG, "Program");

    positionAttribute = GLES31.glGetAttribLocation(programName, "a_Position");
    colorAttribute = GLES31.glGetAttribLocation(programName, "a_Color");
    modelViewProjectionUniform = GLES31.glGetUniformLocation(programName, "u_ModelViewProjection");
    pointSizeUniform = GLES31.glGetUniformLocation(programName, "u_PointSize");
    confidenceThresholdUniform = GLES31.glGetUniformLocation(programName, "u_ConfidenceThreshold");
  ...
  public void draw(float[] viewMatrix, float[] projectionMatrix) {
    ...
    for (DepthData depthFrame : depthFrames) {
      ...
      GLES31.glBufferSubData(
          GLES31.GL_ARRAY_BUFFER, 0, numPoints * POSITION_BYTES_PER_POINT, depthFrame.getPoints());
      ...
      GLES31.glBufferData(GLES31.GL_ARRAY_BUFFER, colorBufferSize, null, GLES31.GL_DYNAMIC_DRAW);
      GLES31.glBufferSubData(
          GLES31.GL_ARRAY_BUFFER, 0, numPoints * COLOR_BYTES_PER_POINT, depthFrame.getColors());
      ...
      GLES31.glVertexAttribPointer(
          positionAttribute, 4, GLES31.GL_FLOAT, false, POSITION_BYTES_PER_POINT, 0);

      GLES31.glEnableVertexAttribArray(colorAttribute);
      GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER, colorBuffer);
      GLES31.glVertexAttribPointer(
          colorAttribute, 4, GLES31.GL_FLOAT, false, COLOR_BYTES_PER_POINT, 0);

      GLES31.glUniformMatrix4fv(modelViewProjectionUniform, 1, false, modelViewProjection, 0);
      GLES31.glUniform1f(pointSizeUniform, 5.0f);
      GLES31.glUniform1f(confidenceThresholdUniform, minConfidence);

      GLES31.glDrawArrays(GLES31.GL_POINTS, 0, numPoints);
      GLES31.glDisableVertexAttribArray(positionAttribute);
      GLES31.glDisableVertexAttribArray(colorAttribute);
      GLES31.glBindBuffer(GLES31.GL_ARRAY_BUFFER, 0);
    }
