...
class TextureReader {
    ...
    private var bufferUsed: Array<Boolean?>  = arrayOf()
    ...
    private var imageFormat = TextureReaderImage.IMAGE_FORMAT_RGBA
    ...
    fun create(context: Context?, format: Int, width: Int, height: Int, keepAspectRatio: Boolean) {
        ...
        GLES31.glGenBuffers(bufferCount, pbo, 0)
        ...
        for (i in 0 until bufferCount) {
            ...
            GLES31.glTexImage2D(
                ...
                0,
                if (imageFormat == TextureReaderImage.IMAGE_FORMAT_I8) GLES31.GL_R8 else GLES31.GL_RGBA,
                imageWidth,
                imageHeight,
                0,
                if (imageFormat == TextureReaderImage.IMAGE_FORMAT_I8) GLES31.GL_RED else GLES31.GL_RGBA,
            ...
            // Setup PBOs
            GLES31.glBindBuffer(GLES31.GL_PIXEL_PACK_BUFFER, pbo!![i])
            GLES31.glBufferData(
                GLES31.GL_PIXEL_PACK_BUFFER, pixelBufferSize, null, GLES31.GL_DYNAMIC_READ
            )
    ...
    fun destroy() {
        ...
        if (pbo != null) {
            GLES31.glDeleteBuffers(bufferCount, pbo, 0)
            pbo = null
        }
    }
    ...
    fun submitFrame(textureId: Int, textureWidth: Int, textureHeight: Int): Int {
        ...
        GLES31.glBindBuffer(GLES31.GL_PIXEL_PACK_BUFFER, pbo!![bufferIndex])
        ...
        GLES31.glReadPixels(
            ...
            imageWidth,
            imageHeight,
            if (imageFormat == TextureReaderImage.IMAGE_FORMAT_I8) GLES31.GL_RED else GLES20.GL_RGBA,
    ...
    fun acquireFrame(bufferIndex: Int): TextureReaderImage {
        ...
        val mapped = GLES31.glMapBufferRange(
            GLES31.GL_PIXEL_PACK_BUFFER, 0, pixelBufferSize, GLES31.GL_MAP_READ_BIT
        ) as ByteBuffer
