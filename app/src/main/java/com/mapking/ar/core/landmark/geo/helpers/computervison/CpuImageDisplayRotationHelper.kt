...
/**
 * Helper to track the display rotations. In particular, the 180 degree rotations are not notified by the onSurfaceChanged() callback,
 * and thus they require listening to the android display events.
 */

class CpuImageDisplayRotationHelper(context: Context) :
    DisplayListener {
    ...
    fun getViewportAspectRatio(): Float {
        ...
        aspectRatio =
            when (getCameraToDisplayRotation()) {
